...
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1002006007017")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
...
URL = "https://zenfilters-7072bfb4eada.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://zenfilters-7072bfb4eada.herokuapp.com/".format(FQDN, PORT)
